...
loader2.load('/public/texturas/Captura de pantalla 2025-09-05 144539.png', (texture)=>{
...
loader3.load('/public/texturas/X101401_220x150cm.webp', (texture)=>{
...
loader4.load('/public/texturas/fondo-texturizado-textil-en-relieve-rosa-pastel.jpg', (texture)=>{
...
const texture = textureLoader.load('/public/texturas/texturas/Leaf0.jpeg');
const normalMap  = textureLoader.load('/public/texturas/texturas/Soil.jpeg');
const jarroMap  = textureLoader.load('/public/texturas/texturas/internal_ground_ao_texture.jpeg');




//candelabro
loaderFbx.load("/public/modelos/barbie candelabro.fbxbarbie candelabro.fbx", function(object){
    object.scale.x=0.04
    object.scale.y=0.03
    object.scale.z=0.04
    object.position.x= 6
...
//piano
loaderFbx.load("/public/modelos/barbie piano.fbx", function(object){
...
//sofa
loaderFbx.load("/public/modelos/barbie sofa.fbx", function(object){
    object.scale.x=0.06
    object.scale.y=0.06
    object.scale.z=0.06
    object.position.x= 5.3
...
//planta
loaderFbx.load("/public/modelos/Plant1.fbx", function(object){
...
//mesa
loaderFbx.load("/public/modelos/barbie mesa.fbx", function(object){
    object.scale.x=0.5
    object.scale.y=0.5
    object.scale.z=0.5
...
//cuadro1
loaderFbx.load("/public/modelos/barbie cuadro1.fbx", function(object){
    object.scale.x=0.3
    object.scale.y=0.3
    object.scale.z=0.3
...
//cuadro2
loaderFbx.load("/public/modelos/barbie cuadro2.fbx", function(object){
    object.scale.x=0.3
    object.scale.y=0.3
    object.scale.z=0.3
...
//lampara
loaderFbx.load("/public/modelos/lampara grande barbie.fbx", function(object){
    object.scale.x=0.04
    object.scale.y=0.04
    object.scale.z=0.04
...
//tv 
loaderFbx.load("/public/modelos/TV.fbx", function(object){
    object.scale.x=0.07
    object.scale.y=0.07
    object.scale.z=0.07
...
//silla
loaderFbx.load("/public/modelos/barbie silla.fbx", function(object){
    object.scale.x=0.25
    object.scale.y=0.25
    object.scale.z=0.25
...
//lucesitas
loaderFbx.load("/public/modelos/LightFixtureRecessed.fbx", function(object){
    object.scale.x=0.04
    object.scale.y=0.03
    object.scale.z=0.04
    object.position.x= 15
...
//tv mesa
loaderFbx.load("/public/modelos/tvstand.fbx", function(object){
    object.scale.x=0.07
    object.scale.y=0.07
    object.scale.z=0.07
    object.position.x= 34
...
//silla
loaderFbx.load("/public/modelos/barbie puff.fbx", function(object){
    object.scale.x=0.25
    object.scale.y=0.25
    object.scale.z=0.25
...
//espejo
loaderFbx.load("/public/modelos/barbie espejo.fbx", function(object){
    object.scale.x=0.3
    object.scale.y=0.3
    object.scale.z=0.3
